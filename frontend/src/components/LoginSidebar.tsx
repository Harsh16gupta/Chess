        ...
        <div className="flex flex-col justify-between w-48 bg-black text-white py-4 border-r border-zinc-900 shrink-0">
            <div className="flex flex-col gap-1">
                ...
                <div className="px-2 mt-4 flex flex-col gap-1">
                    ...
                    <Button 
                        className={`w-full flex justify-start items-center gap-3 font-semibold text-lg p-2.5 pl-4 cursor-pointer rounded-lg transition-all duration-200 ${isActive("/puzzles") ? "bg-white text-black font-bold" : "text-zinc-400 hover:bg-zinc-900 hover:text-white"}`}
            ...
            <div className="px-2">
                <Button 
                    className="w-full flex justify-start items-center gap-3 font-semibold text-lg p-2.5 pl-4 cursor-pointer rounded-lg transition-all duration-200 text-zinc-400 hover:bg-white hover:text-black" 
                    onClick={() => {
                        logout();
                        navigate("/");
                    }}>
