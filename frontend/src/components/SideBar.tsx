...
export const SideBar = () => {
    ...
    return(
        <div className="flex flex-col justify-start w-40 bg-stone-900 text-white">
            <Button 
                className={"w-40 flex justify-center items-center font-bold text-2xl p-2 pt-2 cursor-pointer"} 
                onClick={() => {
                    navigate("/game")
                }}><div>Chess.in</div>
            </Button>
            <Button 
                className={"w-40 flex justify-start items-center font-bold text-xl p-2 pt-2 cursor-pointer"} 
                onClick={() => {
                    navigate("/game")
                }}><div>Play</div>
            </Button>
